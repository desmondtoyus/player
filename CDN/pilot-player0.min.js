...
console.log('Trying to move 33')}}
function fadeIn(ele){console.log('OPACITY VALUE=',ele.style.opacity);if(parseFloat(ele.style.opacity)<1){ele.style.opacity=parseFloat(ele.style.opacity)+0.005;setTimeout(()=>{console.log('inside opacity');fadeIn(ele)},0.5)}};function fadeOut(ele){console.log('OPACITY VALUE=',ele.style.opacity);if(parseFloat(ele.style.opacity)>=0){ele.style.opacity=parseFloat(ele.style.opacity)-0.05;setTimeout(()=>{console.log('inside opacity');fadeOut(ele)},0.5)}};function pause(id){var player=videojs(id);player.ima.pauseAd()}
...
if(endingPlay.parentNode.classList.contains('slider')){endingPlay.parentNode.style.visibility='visible';endingPlay.style.visibility='visible';console.log('CONTAIN SLIDER==1')
console.log('protopype=',this.id)
pilotSlider(this.id)}}
console.log("EVENT",event.type);if(event.type=='start'&&!endingPlay.parentNode.classList.contains('slider')){endingPlay.parentNode.style.visibility='visible';endingPlay.parentNode.style.opacity=0;endingPlay.style.visibility='visible';pause(this.id);fadeIn(endingPlay.parentNode);console.log('PAUSED');if(this.inArticle.indexOf('article')>=0){endingPlay.getElementsByClassName('vjs-control-bar')[0].style.height='0px'}}
if(event.type=='pause'){checkScroll()}
if(event.type=='complete'){if(this.inArticle.indexOf('article')>=0)
{endingPlay.style.display='none';endingPlay.getElementsByClassName('vjs-control-bar')[0].style.display='none';endingPlay.parentNode.style.display='none'}
