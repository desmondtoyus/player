...
if(endingPlay.parentNode.classList.contains('slider')){endingPlay.parentNode.style.visibility='visible';endingPlay.style.visibility='visible';console.log('CONTAIN SLIDER==12')
...
if(document.getElementsByClassName('pilot-video')[i].classList.contains('in_article_fixed')){document.getElementById(playId).classList.remove("pilot-checker")
pause(playId)}}}}}
