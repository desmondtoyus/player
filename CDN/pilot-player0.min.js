...
player.on('adserror',function(){console.log('Error Occured',id);document.getElementById(id).parentNode.style.display='none'});player.one(startEvent,function(){player.ima.initializeAdDisplayContainer()})}}
