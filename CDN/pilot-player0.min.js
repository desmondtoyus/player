...
pilotSlider(this.id)}}
console.log("EVENT",event.type);if(event.type=='start'&&!endingPlay.parentNode.classList.contains('slider')){endingPlay.parentNode.style.visibility='visible';endingPlay.style.visibility='visible';pause(this.id);console.log('PAUSED');if(this.inArticle=='in_article'){endingPlay.getElementsByClassName('vjs-control-bar')[0].style.height='0px'}}
